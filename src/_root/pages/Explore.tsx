...
const Explore = () => {
  ...
  const shouldShowSearchValue = searchValue !== '';
  const shouldShowPosts = !shouldShowSearchValue && posts?.pages.every((item) => item?.documents.length === 0);
    ...
    <div className='explore-container'>
      ...
      <div className="flex-between w-full max-w-5xl mt-16 mb-7">
        ...
        <div className="flex-center gap-3 bg-light-2 rounded-xl px-4 py-2 cursor-pointer">
          <p className='small-medium md:base-medium text-dark-4'>All</p>
